...
<?php 
    if ( isset($javascript_not_enable) ) {
        echo 'JavaScript is NOT enable';
    } else {
        echo '<noscript>JavaScript is not enable</noscript>';
    }

    if( isset($errors) ){
        if(count($errors) > 0){
            foreach($errors as $error => $error_definition) {
                echo '<div>' . $error_definition . '</div>';
            }
        }
    }
?>
